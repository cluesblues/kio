...
KIO::AskUserActionInterface *KIO::defaultAskUserActionInterface()
{
    return s_askUserActionInterface;
}

void KIO::setDefaultAskUserActionInterface(KIO::AskUserActionInterface *askUserInterface)
{
    s_askUserActionInterface = askUserInterface;
}
