...
/**
 * Returns the default AskUserActionInterface to be used by all KIO Jobs.
 * Can return nullptr, if no KIO GUI library was loaded previously.
 */
KIOCORE_EXPORT AskUserActionInterface *defaultAskUserActionInterface();

/**
 * @internal
 *
 * Allows the KIO widgets library to register its widget-based AskUserActionInterface
 * automatically.
 */
KIOCORE_EXPORT void setDefaultAskUserActionInterface(AskUserActionInterface *askUserInterface);
